...
<main class="perfume-section">
  <div style="max-width:900px; margin:40px auto; color:#fffbe5;">
    ...
    <table style="width:100%; background:#121212; padding:20px; border-radius:10px; border-collapse:collapse;">
      ...
      <tr style="border-bottom:1px solid #333;">
        ...
        <td style="padding:10px;"><?php echo htmlspecialchars($p['nombre']); ?></td>
        <td style="padding:10px;"><?php echo htmlspecialchars($p['marca']); ?></td>
        <td style="padding:10px;"><?php echo htmlspecialchars($p['tipo']); ?></td>
        <td style="padding:10px;">
          <img src="<?php echo htmlspecialchars($p['imagen']); ?>" width="50">
        </td>
